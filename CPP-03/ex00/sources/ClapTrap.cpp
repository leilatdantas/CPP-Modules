...
/*   Updated: 2024/08/17 18:15:27 by lebarbos         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "Default constructor has been called; All parameters are set to 0" << std::endl;
}

ClapTrap::ClapTrap(std::string name)
	: _name(name), _hitPoints(10), _energyPoints(10), _attackDamage(0)
{
	std::cout << PINK << name << RESET << " constructor has been called" << std::endl;
}
